About imagedataextractor-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/imagedataextractor-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12596&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/imagedataextractor-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `imagedataextractor` can be installed with `conda`:
...
```
mamba install imagedataextractor
```

It is possible to list all of the versions of `imagedataextractor` available on your platform with `conda`:
...
```
mamba search imagedataextractor --channel conda-forge
```
...
mamba repoquery search imagedataextractor --channel conda-forge

# List packages depending on `imagedataextractor`:
mamba repoquery whoneeds imagedataextractor --channel conda-forge

# List dependencies of `imagedataextractor`:
mamba repoquery depends imagedataextractor --channel conda-forge
```
